...
*/
@Configuration
public class OrchestratedConfiguration extends OLCommonBasicConfiguration {

    private static final String[] servicesPackages = new String[] {"com.orchestrated.openlegacy.services"};

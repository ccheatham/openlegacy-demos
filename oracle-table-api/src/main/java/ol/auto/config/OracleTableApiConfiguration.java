...
*/
@Configuration
public class OracleTableApiConfiguration extends OLCommonBasicConfiguration {

    private static final String[] servicesPackages = new String[] {"com.oracle_table_api.openlegacy.services"};

...
@Component
public class OracleTableApiServiceImpl implements OracleTableApiService {
    ...
    @Override
    @LogServiceUsage
    @ServiceMethod(name = "findAll", entities = { @EntityMapping(alias = "customer", entity = com.oracle_table_sdk.openlegacy.entities.Customer.class) })
    ...
    @Override
    @LogServiceUsage
    @ServiceMethod(name = "findAllPageable", entities = { @EntityMapping(alias = "customer", entity = com.oracle_table_sdk.openlegacy.entities.Customer.class) })
    @BindInputs(endpoints = {})
    @BindOutputs(endpoints = {})
    ...
    @Override
    @LogServiceUsage
    @ServiceMethod(name = "findOne", entities = { @EntityMapping(alias = "customer", entity = com.oracle_table_sdk.openlegacy.entities.Customer.class) })
    @BindInputs(endpoints = {})
    ...
    @Override
    @LogServiceUsage
    @ServiceMethod(name = "create", entities = { @EntityMapping(alias = "customer", entity = com.oracle_table_sdk.openlegacy.entities.Customer.class) })
    @BindInputs(endpoints = {})
    @BindOutputs(endpoints = { @BindFrom(endpoint = "customer", expression = "customer") })
    ...
    @Override
    @LogServiceUsage
    @ServiceMethod(name = "update", entities = { @EntityMapping(alias = "customer", entity = com.oracle_table_sdk.openlegacy.entities.Customer.class) })
    @BindInputs(endpoints = {})
    @BindOutputs(endpoints = { @BindFrom(endpoint = "customer", expression = "customer") })
    ...
    @LogServiceUsage
    @ServiceMethod(name = "findAllByName", entities = { @EntityMapping(alias = "customer", entity = com.oracle_table_sdk.openlegacy.entities.Customer.class) })
    @BindInputs(endpoints = {})
    @BindOutputs(endpoints = {})
    public FindAllByNameOut findAllByName(String name) throws Exception {
    	FindAllByNameOut findAllOut = new FindAllByNameOut();
        /* autogenerated - sessions block start*/
        ;
        /* autogenerated - sessions block end */
        ;
        /* autogenerated - execution block start */
        ;
        findAllOut.setRecords(customerRepository.findByNameContaining(name));
        /* autogenerated - execution block end */
        ;
        /* autogenerated - output block start */
        ;
        findAllOut = serviceBinder.bindOutput(this, "findAllByName", findAllOut, new String[] {});
        /* autogenerated - output block end */
        ;
        return findAllOut;
    }

...
*/
@Configuration
public class DockerMfRpcApiConfiguration extends OLCommonBasicConfiguration {

    private static final String[] servicesPackages = new String[] {"com.docker_mf_rpc_api.openlegacy.services"};

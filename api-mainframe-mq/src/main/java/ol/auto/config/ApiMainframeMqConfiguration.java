...
*/
@Configuration
public class ApiMainframeMqConfiguration extends OLCommonBasicConfiguration {

    private static final String[] servicesPackages = new String[] {"com.api_mainframe_mq.openlegacy.services"};

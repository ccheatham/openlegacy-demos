package com.oracle_table_sdk.openlegacy.config;
...
@EnableJpaRepositories(
        entityManagerFactoryRef = OracleTableSdkConfiguration.DATASOURCE_KEY + DbBeanNames.ENTITIES_REGISTRY_MANAGER_SUFFIX,
        transactionManagerRef = OracleTableSdkConfiguration.DATASOURCE_KEY + DbBeanNames.TRANSACTION_MANAGER_SUFFIX,
        basePackages = { "com.oracle_table_sdk.openlegacy.repositories" })
public class OracleTableSdkConfiguration {
    protected static final String DATASOURCE_KEY = "oracleTableSdk";
    private static final String[] packagesToScan = new String[] {"com.oracle_table_sdk.openlegacy", "com.oracle_table_sdk.openlegacy.entities"};

    private OLDatabaseProjectProperties olDatabaseProjectProperties;

    public OracleTableSdkConfiguration(OLDatabaseProperties olDatabaseProperties) {

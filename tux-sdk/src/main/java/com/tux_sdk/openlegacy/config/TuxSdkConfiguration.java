package com.tux_sdk.openlegacy.config;
 ...
 */
@Configuration
public class TuxSdkConfiguration {
    private static final String ORCHESTRATED_KEY = "tuxSdk";
    private static final String[] packagesToScan = new String[] {"com.tux_sdk.openlegacy"};

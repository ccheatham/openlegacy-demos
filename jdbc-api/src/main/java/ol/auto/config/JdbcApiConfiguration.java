...
*/
@Configuration
public class JdbcApiConfiguration extends OLCommonBasicConfiguration {

    private static final String[] servicesPackages = new String[] {"com.jdbc_api.openlegacy.services"};

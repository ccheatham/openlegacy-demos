...
import com.oracle_customer_sdk.openlegacy.repositories.CustomerRepository;

@Service(name = "JdbcOracle")
@OpenlegacyDesigntime(editor = "WebServiceEditor")
@Component
public class JdbcOracleServiceImpl implements JdbcOracleService {
    ...
    @ServiceMethod(name = "findAll", entities = {
            @EntityMapping(alias = "customer", entity = com.oracle_customer_sdk.openlegacy.entities.Customer.class) })

package com.oracle_sdk.openlegacy.config;
...
@EnableJpaRepositories(
        entityManagerFactoryRef = OracleSdkConfiguration.DATASOURCE_KEY + DbBeanNames.ENTITIES_REGISTRY_MANAGER_SUFFIX,
        transactionManagerRef = OracleSdkConfiguration.DATASOURCE_KEY + DbBeanNames.TRANSACTION_MANAGER_SUFFIX,
        basePackages = { "com.oracle_sdk.openlegacy.repositories" })
public class OracleSdkConfiguration {
    protected static final String DATASOURCE_KEY = "oracleSdk";
    private static final String[] packagesToScan = new String[] {"com.oracle_sdk.openlegacy", "com.oracle_sdk.openlegacy.entities"};

    private OLDatabaseProjectProperties olDatabaseProjectProperties;

    public OracleSdkConfiguration(OLDatabaseProperties olDatabaseProperties) {

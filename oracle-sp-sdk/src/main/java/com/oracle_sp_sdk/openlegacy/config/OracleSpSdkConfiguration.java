package com.oracle_sp_sdk.openlegacy.config;
 ...
 */
@Configuration
public class OracleSpSdkConfiguration {
    private static final String ORCHESTRATED_KEY = "oracleSpSdk";
    private static final String[] packagesToScan = new String[] {"com.oracle_sp_sdk.openlegacy"};

...
*/
@Configuration
public class MysqlTableApiConfiguration extends OLCommonBasicConfiguration {

    private static final String[] servicesPackages = new String[] {"com.mysql_table_api.openlegacy.services"};

...
import com.mysql_table_sdk.openlegacy.repositories.CustomerRepository;

@Service(name = "MySQLTableApi")
@OpenlegacyDesigntime(editor = "WebServiceEditor")
@Component
public class MySQLTableApiServiceImpl implements MySQLTableApiService {
    ...
    @ServiceMethod(name = "findAll", entities = {
            @EntityMapping(alias = "customer", entity = com.mysql_table_sdk.openlegacy.entities.Customer.class) })

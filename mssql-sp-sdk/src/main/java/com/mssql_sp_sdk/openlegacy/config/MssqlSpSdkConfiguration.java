package com.mssql_sp_sdk.openlegacy.config;
 ...
 */
@Configuration
public class MssqlSpSdkConfiguration {
    private static final String ORCHESTRATED_KEY = "mssqlSpSdk";
    private static final String[] packagesToScan = new String[] {"com.mssql_sp_sdk.openlegacy"};

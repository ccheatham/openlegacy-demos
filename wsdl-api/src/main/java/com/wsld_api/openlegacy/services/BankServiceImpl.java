...
public class BankServiceImpl implements BankService {
    ...
    @BindOutputs(endpoints = {
            @BindFrom(endpoint = "plz", expression = "getBank.outputParams.getBankResponse.details.plz"),
            @BindFrom(endpoint = "ort", expression = "getBank.outputParams.getBankResponse.details.ort"),
            @BindFrom(endpoint = "bic", expression = "getBank.outputParams.getBankResponse.details.bic"),
            @BindFrom(endpoint = "bezeichnung", expression = "getBank.outputParams.getBankResponse.details.bezeichnung")})

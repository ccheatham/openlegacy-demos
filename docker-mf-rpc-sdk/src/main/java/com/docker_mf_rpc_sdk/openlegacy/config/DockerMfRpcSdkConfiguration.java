package com.docker_mf_rpc_sdk.openlegacy.config;
 ...
 */
@Configuration
public class DockerMfRpcSdkConfiguration {
    private static final String ORCHESTRATED_KEY = "dockerMfRpcSdk";
    private static final String[] packagesToScan = new String[] {"com.docker_mf_rpc_sdk.openlegacy"};
    ...
    public RpcConnectionFactory rpcConnectionFactory(
            OLCicsProperties properties,
            @Qualifier(ORCHESTRATED_KEY + RpcBeanNames.TRANSPORTER_FACTORY_SUFFIX) RpcTransporterFactory<MfRpcHttpTransporter> transporterFactory) {
        return OLRpcMfBeanUtils.cicsConnectionFactory(ORCHESTRATED_KEY, properties, transporterFactory);
    }
    ...
    public RpcTransporterFactory<MfRpcHttpTransporter> transporterFactory(
        ...
        return OLRpcMfBeanUtils.cicsTransporterFactory(ORCHESTRATED_KEY, olCicsProperties, cicsInnerServer, olDebugProperties, cicsHeaderUtil);
    }
    ...
    public static RpcInputFormatter<byte[]> cicsInputFormatter(
            OLCicsProperties olCicsProperties,
    ...
    public static RpcBindCallback<ByteArrayOutputStream> cicsBindInputCallback(
    ...
    public RpcOutputFormatter<byte[]> cicsOutputFormatter(
            OLDebugProperties olDebugProperties,
    ...
    public static RpcBindCallback<ByteArrayInputStream> cicsBindOutputCallback(
